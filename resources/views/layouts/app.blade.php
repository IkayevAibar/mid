...
<head>
    ...
    <title>{{ config('app.name', 'Blost') }}</title>
...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md  navbar-laravel " style="background-color: black; color:blanchedalmond;">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    {{ config('app.name', 'Blost') }}
                </a>
                        ...
                        @else
                            ...
                            <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item active" href="profile/{{ Auth::user()->id }}">
                                        {{ __('My Profile') }}
                                    </a>
                                    --------------------------
